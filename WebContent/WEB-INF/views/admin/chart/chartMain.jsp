...
function loading(){
	...
	$('#line-chart').find('.legendLabel').eq(0).text('20대');
	$('#line-chart').find('.legendLabel').eq(1).text('10대');
	$('#line-chart').find('.legendLabel').eq(2).text('30대');
	
	$('#PercentilesChart').find('.legendLabel').eq(0).text('여성');
	$('#PercentilesChart').find('.legendLabel').eq(1).text('남성');
}
</script>
</head>
<body onload="loading();">
                    ...
                    <div class="col-lg-6">
                        <div class="portlet box" id="LineChart">
                            <div class="portlet-header">
                                <div class="caption">연령대별 게시판 사용량</div>
...
<!--                         </div> -->
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="portlet box" id="AreaChart">
                            <div class="portlet-header" >
                                <div class="caption">상위 2개 게시판 월별 사용량</div>
                                <div class="tools"><i class="fa fa-chevron-up"></i><i data-toggle="modal" data-target="#modal-config" class="fa fa-cog"></i><i class="fa fa-refresh"></i><i class="fa fa-times"></i></div>
                            </div>
                        ...
                        <div class="portlet box" id="PercentilesChart">
                            <div class="portlet-header">
                                <div class="caption">넣을게 없습니다!!!</div>
                                <div class="tools"><i class="fa fa-chevron-up"></i><i data-toggle="modal" data-target="#modal-config" class="fa fa-cog"></i><i class="fa fa-refresh"></i><i class="fa fa-times"></i></div>
                            </div>
                            <div class="portlet-body">
