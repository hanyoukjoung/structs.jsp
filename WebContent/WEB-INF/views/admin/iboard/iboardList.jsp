...
<div id="imgboardList_content">
	<div class="panel panel-blue">
		...
		<table id="table" class="table table-bordered table-hover">
			...
			<c:forEach items="${iboardList }" var="boardInfo">
...
<div >
${paginationHTML}
<form action="/admin/iboard/iboardList.do" method="post" name="searchForm" class="form-inline pull-right">
