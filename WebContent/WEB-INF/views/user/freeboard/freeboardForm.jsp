...
<body>
<form class="form-horizontal" name="insertForm" role="form" action="/user/freeboard/insertFreeboard.do" method="post" enctype="multipart/form-data">
	...
	<div class="form-group"> 
		<div class="col-sm-offset-2 col-sm-10">
			...
			<button type="reset" id="cancelBTN" class="btn btn-danger" style="float: right">취소</button>
