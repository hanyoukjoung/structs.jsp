...
<body>
	<div class="panel panel-orange">
	    ...
	    <div class="panel-body pan">
	        <form name="memberRegForm" action="/member/insertMember.do" method="post" enctype="multipart/form-data">
...
<!-- 	            </div> -->
	            ...
	            <div class="row">
	                ...
	                <div class="col-md-2">
	                    <div class="form-group">
	                        <input id="mem_zipcode" name="mem_zipcode" type="text" placeholder="우편번호" class="form-control" /></div>
	                </div>
	                <div class="col-md-4">
	                    <div class="form-group">
	                        <input id="mem_add1" name="mem_add1"type="text" placeholder="주소" class="form-control" /></div>
	                </div>
	                <div class="col-md-4">
	                    <div class="form-group">
