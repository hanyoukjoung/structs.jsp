...
public class RBoardVO {
	...
	public RBoardVO(String bo_no, String bo_title, String bo_writer,
			String bo_nick, String bo_pass, String bo_ip, String bo_cont,
			String bo_hit, String bo_reg_date, String bo_del, String bo_group,
			String bo_seq, String bo_depth, String rnum, List<BoardFileVO> items) {
		super();
		this.bo_no = bo_no;
		this.bo_title = bo_title;
		this.bo_writer = bo_writer;
		this.bo_nick = bo_nick;
	...
	public String getBo_nick() {
		return bo_nick;
	}
	public void setBo_nick(String bo_nick) {
		this.bo_nick = bo_nick;
	}
